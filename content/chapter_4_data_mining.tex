...
Best scores are reached with the k-NN and the Support Vector Classifier. K-Nearest Neigbor classifier work best with values close to the training example, as it calculates the distance between the features. An object itself is than classified by the majority votes of each neighbor.
