...
%	\caption{Overview of the results and parameters of each classifier \footnote{Hyperparamter listed show only the differences to default values given in the \textit{scikit}-documentation.}}
